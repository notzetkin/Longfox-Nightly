...
var urlbar_on_toolbar_position = 1;
var menunar_on_toolbar_position = 0;
...
var MoveUrlbar = {
  init: function() {
	...
	CustomizableUI.addWidgetToArea("menubar-items", "additional_top_toolbar1");
	CustomizableUI.moveWidgetWithinArea("menubar-items", menunar_on_toolbar_position)
	...
	CustomizableUI.addWidgetToArea("unified-extensions-button", "additional_top_toolbar2");
